...
// 									<div
// 										key={item.id}
// 										className="flex items-center justify-between border-b border-brand-border p-2"
// 									>
// 										{/* Item */}
...
// 										{/* Quantity */}
// 										<div className="flex w-fit items-center overflow-hidden rounded-xl  border-brand-border">
// 										<button

// 											className="  text-brand-main transition hover:bg-brand-primary hover:text-brand-dark"
// 										>
// 											-
// 										</button>

// 										<span className=" border-x border-brand-border px-4 py-2 text-center text-brand-main">
// 											{item.quantity}
// 										</span>
